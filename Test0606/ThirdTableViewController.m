...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.textLabel.text= event.eventName;    cell.detailTextLabel.text=message;
...
- (void)insertNewObjectEventName:(NSString *)eventName eventTime:(NSString *)eventTime eventLocation:(NSString*)eventLocation {
    NSLog(@"Reading from Add Call %@ %@ %@", eventName, eventTime,eventLocation);
    ...
    [newManagedObject setValue:eventLocation forKey:@"eventLocation"];
    
    // Save the context.
    NSError *error = nil;
    if (![context save:&error]) {
        NSLog(@"Save Event at Third: Unresolved error %@, %@", error, [error userInfo]);
        abort();
    }
}
...
- (void)controller:(NSFetchedResultsController *)controller didChangeObject:(id)anObject       atIndexPath:(NSIndexPath *)indexPath forChangeType:(NSFetchedResultsChangeType)type      newIndexPath:(NSIndexPath *)newIndexPath{
    ...
    switch(type) {
        case NSFetchedResultsChangeInsert:
            [tableView insertRowsAtIndexPaths:@[newIndexPath]withRowAnimation:UITableViewRowAnimationFade];            break;
